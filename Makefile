...
# components tags
GODWOKEN_REF := v1.2.1-rc1 # https://github.com/nervosnetwork/godwoken/releases/tag/v1.2.1-rc1
GODWOKEN_SCRIPTS_REF := v1.2.0 # https://github.com/nervosnetwork/godwoken-scripts/releases/tag/v1.2.0
